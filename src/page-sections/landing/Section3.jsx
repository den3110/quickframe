        ...
        <Grid item lg={7} md={6} xs={12}>
          <Stack spacing={4}>
            ...
            <Stack direction="row" alignItems="center" spacing={2}>
              ...
              <Avatar variant="rounded" alt="Remy Sharp" src="/static/user/user-12.jpg" sx={{
              width: 60,
              height: 60
            }} />
              ...
              <Chip avatar={<Avatar alt="Natacha" src="/static/user/user-12.jpg" />} label="Avatar" color="error" />
