...
const Header = () => {
  ...
  const LARGE_DEVICE_CONTENT = <FlexBox component="nav" sx={LIST_STYLE}>
      ...
      <Box component={Link} href="http://quickframe-doc.vercel.app/" color="text.primary">
        Documentation
      </Box>
        ...
        <Scrollbar>
          ...
          height: "100%"
            ...
            mb: 1
              ...
              <img src="/static/logo/wacbot.png" alt="logo" width={40} height={40} />
            </ListItem>
            ...
            <ListItem disablePadding>
              <ListItemButton LinkComponent="a" href="http://quickframe-doc.vercel.app/">
                Documentation
              </ListItemButton>
            </ListItem>
  ...
  return <FlexBetween component="header" py={2}>
      ...
      <Box display="flex" component={Link} href="/" alignItems="center" gap={0.5}>
        <img src="/static/logo/wacbot.png" alt="logo" width={35} height={35} />
