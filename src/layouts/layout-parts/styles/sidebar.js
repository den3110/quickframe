...
export const BulletIcon = styled(Box)(({ theme, active }) => ({
  width: 4,
  height: 4,
  marginLeft: "10px",
  marginRight: "8px",
...
export const ItemText = styled(Span)(({ theme, compact, active }) => ({
  fontSize: 14,
  whiteSpace: "nowrap",
  paddingLeft: "0.8rem",
...
export const ListLabel = styled(Paragraph)(({ theme, compact }) => ({
  fontSize: 12,
  marginTop: 20,
  marginLeft: 15,
  fontWeight: 600,
...
export const InternalLink = styled("a")(({ theme }) => ({
  overflow: "hidden",
  whiteSpace: "pre",
  marginBottom: "8px",
  textDecoration: "none",
