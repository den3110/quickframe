...
const MuiDataGrid = Loadable(
  lazy(() => import("pages/examples/mui/data-grid"))
);
const MuiTreeview = Loadable(
  lazy(() => import("pages/examples/mui/tree-view"))
);
const MuiAccordion = Loadable(
  lazy(() => import("pages/examples/mui/accordion"))
);
const MuiTextField = Loadable(
  lazy(() => import("pages/examples/mui/textfield"))
);
const MuiPagination = Loadable(
  lazy(() => import("pages/examples/mui/pagination"))
);
const MuiBreadcrumbs = Loadable(
  lazy(() => import("pages/examples/mui/breadcrumbs"))
);
const MuiRadioButton = Loadable(
  lazy(() => import("pages/examples/mui/radio-button"))
);
const MuiAutocomplete = Loadable(
  lazy(() => import("pages/examples/mui/autocomplete"))
);
const MuiTransferList = Loadable(
  lazy(() => import("pages/examples/mui/transfer-list"))
);
